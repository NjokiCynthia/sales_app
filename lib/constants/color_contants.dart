...
const Color primaryDarkColor = Color.fromRGBO(1, 47, 107, 1);
...
const Color greyColor = Color.fromARGB(255, 201, 196, 197);
...
const Map<int, Color> primaryColorMap = {
  ...
  100: Color.fromARGB(255, 24, 28, 51),
  200: Color.fromARGB(255, 24, 28, 51),
  300: Color.fromARGB(255, 24, 28, 51),
  400: Color.fromARGB(255, 24, 28, 51),
  500: Color.fromARGB(255, 24, 28, 51),
  600: Color.fromARGB(255, 24, 28, 51),
  700: Color.fromARGB(255, 24, 28, 51),
  800: Color.fromARGB(255, 24, 28, 51),
  900: Color.fromARGB(255, 24, 28, 51),
};
